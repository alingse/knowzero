...
def upgrade() -> None:
    op.execute("UPDATE messages SET message_type = 'document_card' WHERE message_type = 'document_status'")
    ...
    op.execute("UPDATE messages SET role = 'assistant' WHERE message_type = 'document_card' AND role = 'system'")


def downgrade() -> None:
    op.execute("UPDATE messages SET role = 'system' WHERE message_type = 'document_card' AND role = 'assistant'")
    ...
    op.execute("UPDATE messages SET message_type = 'document_status' WHERE message_type = 'document_card'")
